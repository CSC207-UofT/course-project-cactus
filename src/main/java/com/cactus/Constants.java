...
public class Constants {
    ...
    public static final String[] OPTIONS = {"Create new user", "Log in",
            "Create new list", "Add item to list",
            "Display grocery items", "Delete user", "Exit"};
    ...
    public static final String GET_CATEGORY = "Please enter a category for the grocery item: ";
}
